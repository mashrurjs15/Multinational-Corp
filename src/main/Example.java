...
public class Example implements Serializable {
	 ...
	 *            Metric of feature
	 * @param d2
	 *            list of Numbers or elements in the cartesian feature
	 * @param num
	 *            size of list
	 */
	 ...
	 *            Metric of feature
	 * @param v
	 *            String representaion of the boolean value
	 */
	 ...
	 *            Metric of feature
	 * @param d1
	 *            value of the number held in the Number
	 */
	 ...
	 *            Metric of feature
	 * @param c
	 *            Colour ENUM to be added as a feature
	 */
	...
	/**
	 * Creates new DamagePercent feature and adds it to the list of features in
	 * example.
	 * 
	 * @param s
	 *            Name of Feature
	 ...
	 *            Metric of feature
	 * @param num
	 *            int value representing the percentage
	 */
	...
	/**
	 * This creates a feature with no value used only for the generic list of
	 * features that appear at the top of the GUI
	 * 
	 * @param t
	 *            type of feature
	 * @param s
	...
	public Feature getUnsolvedFeature() {
		for (int i = 0; i < features.size(); i++) {
			if (features.get(i).isEmpty()
					|| (features.get(i).GetName().equals("Colour") && features.get(i).GetValue().equals(7)))
				return features.get(i);
		}
		return null; // there is no empty features Thus this testing example should've been in the
						// training list or was made incorrectly
	}

	public Feature getFeature(String s) {
		for (int i = 0; i < features.size(); i++) {
			if (s.equals(features.getElementAt(i).GetName()))
				return features.get(i);
		}
		return null;
	}
